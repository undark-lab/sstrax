...
def dynamics_solver(
    ...
    """
    try:
        return _dynamics_solver_base(y0, t0, t1, dense, rtol, atol, max_steps)
        ...
        if "max_steps" in str(e):
            ...
            return dynamics_solver(
                y0, t0, t1, dense, rtol, atol, max_steps, maxstep_warnings
            )
...
def mass_solver(
    ...
    try:
        ...
        if "max_steps" in str(e):
            ...
            return mass_solver(
                params, cluster_solution, rtol, atol, max_steps, maxstep_warnings
            )
        # reraise the exception if it is not due to max-steps being hit
        raise e
